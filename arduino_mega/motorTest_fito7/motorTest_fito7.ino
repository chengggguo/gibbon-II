...
int openSpeed = 80; //The higher this number the slower the reaction
int closeSpeed = 3; //The higher this number the slower the reaction
int timeOpen = 200; //time bubbles open //The higher this number the slower the reaction
...
bool ison = true;
int generalCycle = 0;
int generalLoopLimit = 20; // default use 90 // measured in the system's cycles --> about 1 second each cycle
unsigned long halt1 = 8000;// first delay when arms are UP for ---- 8 mins use 480000
unsigned long halt2 = 8000;// second delay when arms are DOWN for ---- 8 mins use 480000
int delayBeforeCollapse = 10000;
//----------------------------------
void setup() {
  Serial.begin(9600);
