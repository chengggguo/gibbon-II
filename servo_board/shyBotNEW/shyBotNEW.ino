...
void defaultSweep (GeneralSweep callback) {
  if (sweepCount > defaultSweepLimit) {
    ...
    String runCom = "#0 P690 S300 #1 P2300 S300 #8 P700 S300 #9 P2300 S300 #16 P700 S300 #17 P2300 S300 #4 P900 S300 #5 P2100 S300 #12 P900 S300 #13 P2100 S300 #20 P900 S300 #21 P2100";
...
void defaultSensorRead (SensorRead callback) {
  values [0] = "#0 P930 S300 #1 P2100 S300";
  ...
  for (int i = 0; i < totalSensors; i++) {
    ...
    if (sensors[i] == 1) {
      ...
      switch (sensorPins[i]) {
        case 2:
          values[i] = "#0 P690 S300 #1 P2300 S300";
          break;
        case 4:
        ...
        case 13:
          ...
          break;
        default:
          values [0] = "#0 P690 S300 #1 P2300 S300";
