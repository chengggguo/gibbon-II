int sweepCount = 0;
int defaultSweepLimit = 50;

int collapseCount = 0;
int defaultCollapseLimit = 10;
...
void defaultSweep (GeneralSweep callback) {
  if (sweepCount > defaultSweepLimit) {
    ...
    String runCom = "#0 P740 S300 #1 P2300 S300 #8 P700 S300 #9 P2300 S300 #16 P700 S300 #17 P2300 S300 #4 P900 S300 #5 P2100 S300 #12 P900 S300 #13 P2100 S300 #20 P900 S300 #21 P2100 S300";
    ...
    Serial.print(runCom);
    Serial.print("\r");
    Serial.print("#3 P650 S500  #7 P650 S500 #11 P650 S500 #15 P650 S500 #19 P650 S500 #23 P650 S500");
    Serial.print("\r");
    delay(4000);
    sweepCount++;
    collapseCount = 0;
...
void collapse() {
  ...
  String stopCom = "#0 P2050 S400 #1 P1000 S400 #8 P2000 S400 #9 P1000 S400 #16 P2000 S400 #17 P1000 S400 #4 P1700 S250 #5 P1300 S250 #12 P1700 S250 #13 P1300 S250 #20 P1700 S250 #21 P1300 S250";
  Serial.print(stopCom);
  Serial.print("\r");
  delay(1000);
  collapseCount ++;
...
void defaultSensorRead (SensorRead callback) {
  values [0] = "#0 P950 S300 #1 P2100 S300";
  ...
  for (int i = 0; i < totalSensors; i++) {
    ...
    if (sensors[i] == 1) {
      ...
      switch (sensorPins[i]) {
        case 2:
          values[i] = "#0 P740 S300 #1 P2300 S300";
          break;
        case 4:
        ...
        case 13:
          ...
          break;
        default:
          values [0] = "#0 P740 S300 #1 P2300 S300";
